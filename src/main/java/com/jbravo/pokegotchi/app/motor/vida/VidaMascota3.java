...
public class VidaMascota3 extends Thread{
    ...
    public void run(){
        ...
        try{
            ...
            do {
                Jugador.getPokemons(posicionMascota).setVida();
