...
public class PokemonGen extends Pokemon{
    ...
    public PokemonGen(String nombrePokemon, String apodo, String aspecto, String fechaDeNacimiento, int nivel) {
        super(nombrePokemon, apodo, aspecto, fechaDeNacimiento, nivel);
    }
